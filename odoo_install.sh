...
echo -e "\n---- Criando o ODOO PostgreSQL User  ----"
...
echo -e "\n---- Criando o diretorio custom module ----"
sudo su $OE_USER -c "mkdir $OE_HOME/custom"
sudo su $OE_USER -c "mkdir $OE_HOME/custom/addons"

echo -e "\n---- Configurando as permissoes da pasta HOME ----"
...
# Configure ODOO
#--------------------------------------------------
echo -e "* Criando o arquivo de configuracao do server"
...
echo -e "* Criando o arquivo startup"
...
echo -e "* Start ODOO com Startup"
sudo update-rc.d $OE_CONFIG defaults
 
sudo service $OE_CONFIG start
echo "Pronto! O servidor ODOO foi inicializado com: service $OE_CONFIG start"
